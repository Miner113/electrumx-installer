...
This installs electrumx using the default options:
    ...
    wget https://raw.githubusercontent.com/Miner113/electrumx-installer/master/bootstrap.sh -O - | bash
...
For example:
    ...
    wget https://raw.githubusercontent.com/Miner113/electrumx-installer/master/bootstrap.sh -O - | bash -s - -d /media/ssd/electrum-db
...
[`distributions/README.md`](https://github.com/Miner113/electrumx-installer/blob/master/distributions/README.md) to find out how to add it.
Or open an [issue](https://github.com/Miner113/electrumx-installer/issues/new) if you'd rather not do that yourself.
